...
#include <sales_completion_message.h>
...
#include "tmk_download_message.h"
...
Host::Status Host::PerformTMKDownload(TMKDownloadMessage& tmk_download_msg) {

  return PerformOnline(&BuildTMKDownloadRequest,
                       &ReadAndValidateTMKDownloadResponse,
                       tmk_download_msg);
}
