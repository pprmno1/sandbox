...
#include <diners/terminal_configuration.h>
...
void SetField62(const std::string& field62, iso8583::Apdu& apdu) {
  apdu.SetField(kField62, field62);
}

void SetField63(const std::string& field63, iso8583::Apdu& apdu) {
  apdu.SetField(kField63, field63);
}

void SetTrack1(const std::string& track1,
                       iso8583::Apdu& apdu) {
    apdu.SetField(kFieldTrack1Data, track1);
}
...
void SetTrack3(const std::string& track3,
                       iso8583::Apdu& apdu) {
    apdu.SetField(kFieldTrack3Data, track3);
}
...
std::string GetMid(const iso8583::Apdu& apdu) {
  return apdu.GetFieldAsString(kFieldCardAcceptorId);
}
